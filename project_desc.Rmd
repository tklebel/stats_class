...
Nachdem die korrekten Daten bekannt sind (https://www.kaggle.com/c/house-prices-advanced-regression-techniques/data?select=train.csv) 
kann abschließend auch der "wahre" root mean squared error berechnet werden.
